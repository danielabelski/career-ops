...
## [0.11.0](https://github.com/danielabelski/career-ops/compare/web-v0.10.0...web-v0.11.0) (2026-09-15)


### Features

* **oferta:** add evidence-tiered requirement importance to Block B ([#3596](https://github.com/danielabelski/career-ops/issues/3596)) ([14710e2](https://github.com/danielabelski/career-ops/commit/14710e29a6a801ea3ae52bb3f15756dc9ada7d29))
* **providers:** add Feishu Jobs and MokaHR scanner providers ([#3491](https://github.com/danielabelski/career-ops/issues/3491)) ([1696bec](https://github.com/danielabelski/career-ops/commit/1696bec4d021768e7359f9aad6b329cba883da20))
* **web:** add a global "Back to Top" button ([#2821](https://github.com/danielabelski/career-ops/issues/2821)) ([e5e786b](https://github.com/danielabelski/career-ops/commit/e5e786b1116e6c5e4c5bd2020f3bc1f6e5dd2058))
* **web:** opt-in origin allowlist for the local dashboard API ([#3597](https://github.com/danielabelski/career-ops/issues/3597)) ([0754973](https://github.com/danielabelski/career-ops/commit/075497329a55d7c1e5184cfffb21fd0efeaf13ba))
...
* **tracker:** resolve addition columns by name so score and status cannot transpose ([00b0296](https://github.com/danielabelski/career-ops/commit/00b0296c6071eb955f38404e60a10ceaccad45b5))
* **web,dashboard:** point two user-facing references at the repository's new home ([6c0e68d](https://github.com/danielabelski/career-ops/commit/6c0e68d472d4ee1e0082fd861c133778f262ecfe))
* **web:** a company with no usable slug must not match every tailored CV ([#3214](https://github.com/danielabelski/career-ops/issues/3214)) ([880c58b](https://github.com/danielabelski/career-ops/commit/880c58b999033b7f38439f20246943e9342e7fdf))
...
* **web:** detect a real tailored CV/cover on disk, not just the tracker flag ([0fb2080](https://github.com/danielabelski/career-ops/commit/0fb2080db1a5c90b3655bff7fdf74593026adf04))
* **web:** don't let a failed fetch become a scored report ([#3826](https://github.com/danielabelski/career-ops/issues/3826)) ([10ede60](https://github.com/danielabelski/career-ops/commit/10ede60522f1abd71dfd8c93266f9176180213ac))
* **web:** enable apply from the generated pdf index ([ac761fa](https://github.com/danielabelski/career-ops/commit/ac761fa612fc943b1ef9458f704fefd653954955))
* **web:** fence agent CLIs at the spawn boundary ([1d2cb1e](https://github.com/danielabelski/career-ops/commit/1d2cb1e125ea3034ff01b464e9a5e2628c0e315f))
* **web:** find Grok in its default install dirs, not only on PATH ([77657dc](https://github.com/danielabelski/career-ops/commit/77657dcd0bcb7c2e9a9950148d337d160aa5b459))
* **web:** give grok a parser, and make the token fold per-CLI ([#2689](https://github.com/danielabelski/career-ops/issues/2689)) ([c7549fb](https://github.com/danielabelski/career-ops/commit/c7549fb3593f9ee456d7118beb80b0ee6e76747c))
...
* **web:** harden post-merge fencing checks ([55152d0](https://github.com/danielabelski/career-ops/commit/55152d002d8816a27ea73d486f13551aaa256662))
...
* **web:** identify the verdict block by its heading, not by the letter ([#3502](https://github.com/danielabelski/career-ops/issues/3502)) ([0ef1bfb](https://github.com/danielabelski/career-ops/commit/0ef1bfbe2385551af415e05858900710d0aadd23))
...
* **web:** make the fencing probe suite portable, and close two scan gaps ([cc16ede](https://github.com/danielabelski/career-ops/commit/cc16ede4f19e88dfeed66891570fa2f6211b3a41))
* **web:** normalize Codex config keys and stop the probe hanging on a held pipe ([c35ffb5](https://github.com/danielabelski/career-ops/commit/c35ffb5ecedf6f05e6489171c8a1b8070a660b5f))
...
* **web:** order the Today action queue before truncating it ([3a067ee](https://github.com/danielabelski/career-ops/commit/3a067ee580b7982cf5dd6edf7895112e4e99600b))
* **web:** parseCliJson misses set-status.mjs's pretty-printed success ([#3602](https://github.com/danielabelski/career-ops/issues/3602)) ([848ca44](https://github.com/danielabelski/career-ops/commit/848ca440fb2d243ae08205ab3d0bc12903a36c65))
* **web:** preserve a malformed portals.yml instead of overwriting it with the example ([07ed4f3](https://github.com/danielabelski/career-ops/commit/07ed4f31295bee9d03ce1ab61d6d59c835431ff7))
* **web:** rank "Awaiting your decision" by every EVALUATED alias, not an English prefix ([d7573e1](https://github.com/danielabelski/career-ops/commit/d7573e189193993c56d19c9216313f0fd4cebee2))
* **web:** reconcile Codex fencing with the inline sandbox from [#2361](https://github.com/danielabelski/career-ops/issues/2361) ([7176b8a](https://github.com/danielabelski/career-ops/commit/7176b8af5dd49f9c091d5c553c65e3d3f9f04952))
...
* **web:** require the cv- prefix so the tailored-CV resolvers stop returning the cover letter ([#2156](https://github.com/danielabelski/career-ops/issues/2156)) ([414d340](https://github.com/danielabelski/career-ops/commit/414d340b4425bf199ddad36dfc0a551da4e99fe0))
* **web:** resolve the tailored cover for THIS application, not the company's newest ([8fc2bb4](https://github.com/danielabelski/career-ops/commit/8fc2bb41db2aad7bf50902ad8a26e726c9637eec))
* **web:** resolve the tailored CV for THIS application, not the newest for the company ([ca11627](https://github.com/danielabelski/career-ops/commit/ca116279d3a5ba9a18e57e3f03f056066c178649))
...
* **web:** self-host the production fonts so the app starts without Google ([a2e46c3](https://github.com/danielabelski/career-ops/commit/a2e46c329fa9819ca6748a437c4ecdbdac4a6ec2))
* **web:** show a cause-specific hint on job failure instead of an always-auth prompt ([#2158](https://github.com/danielabelski/career-ops/issues/2158)) ([d372908](https://github.com/danielabelski/career-ops/commit/d37290897f15f5284788c34cafcdabd3bd56f5bf))
...
* **web:** stop evaluation tables collapsing to one word per line ([#3254](https://github.com/danielabelski/career-ops/issues/3254)) ([b3c1e12](https://github.com/danielabelski/career-ops/commit/b3c1e127e02c588aeefb8d02d14759706ecf1fc2))
...
* **web:** tell the beta reporter's user when the dupe search could not run ([77bf490](https://github.com/danielabelski/career-ops/commit/77bf4906abc5c5f63ac07a6c27a7f24c1d03683d))
* **web:** tighten Codex fencing validation ([1de0a8b](https://github.com/danielabelski/career-ops/commit/1de0a8bbba4da3df3da1ae331a3b1efef80ef10d))
* **web:** tighten the Codex fencing guard and its capability probe ([33ac959](https://github.com/danielabelski/career-ops/commit/33ac959d41b94cf84c03acdab1e5758c2f0b5c83))
